...
namespace behaviac
{
	...
	public: 
		CMethod_FirstAgent_Say() : _param0(0) 
		{
		}

		CMethod_FirstAgent_Say(CMethod_FirstAgent_Say &rhs) : CAgentMethodVoidBase(rhs) , _param0(0) 
		{
		}
		...
		virtual void run(Agent* self)
		{
			...
			((FirstAgent*)self)->_Execute_Method_<METHOD_TYPE_FirstAgent_Say, void, behaviac::string& >(pValue_param0);
		}
	};
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(3286199445u);
			...
			// FirstAgent
			meta = BEHAVIAC_NEW AgentMeta(1153314180u);
