...
namespace behaviac
{
	...
	inline void Set_FirstAgent_p1(Agent* self, FirstEnum value) { ((FirstAgent*)self)->_Get_Property_<PROPERTY_TYPE_FirstAgent_p1, FirstEnum >() = value; };
	inline const void* Get_FirstAgent_p1(Agent* self) { return &((FirstAgent*)self)->_Get_Property_<PROPERTY_TYPE_FirstAgent_p1, FirstEnum >(); };
