...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(1978484590u);
			...
			// FirstAgent
			meta = BEHAVIAC_NEW AgentMeta(2866702920u);
			AgentMeta::GetAgentMetas()[1778122110u] = meta;
			meta->RegisterMemberProperty(2082220067u, BEHAVIAC_NEW CMemberProperty< FirstEnum >("p1", Set_FirstAgent_p1, Get_FirstAgent_p1));
