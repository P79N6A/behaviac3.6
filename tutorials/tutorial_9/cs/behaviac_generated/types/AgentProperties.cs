...
namespace behaviac
{
	...
	public class BehaviorLoaderImplement : BehaviorLoader
	{
		...
		{
			AgentMeta.TotalSignature = 1978484590;
			...
			// FirstAgent
			meta = new AgentMeta(2866702920);
			AgentMeta._AgentMetas_[1778122110] = meta;
			meta.RegisterMemberProperty(2082220067, new CMemberProperty<FirstEnum>("p1", delegate(Agent self, FirstEnum value) { ((FirstAgent)self)._set_p1(value); }, delegate(Agent self) { return ((FirstAgent)self)._get_p1(); }));
