...
namespace behaviac
{
	...
	public: 
		CInstanceConst_FirstStruct(const char* valueStr) : CInstanceConstBase<FirstStruct>(valueStr)
		{
			...
			_s2 = AgentMeta::TParseProperty<float >(paramStrs[1].c_str());
		}
		...
		virtual void run(Agent* self)
		{
			...
			_value.s2 = *(float*)_s2->GetValue(self, behaviac::Meta::IsVector<float >::Result, behaviac::GetClassTypeNumberId<float >());
		}
	};
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(3481663041u);

			AgentMeta* meta = NULL;
			BEHAVIAC_UNUSED_VAR(meta);

			// FirstStruct
			meta = BEHAVIAC_NEW AgentMeta(936018459u);
			...
			meta->RegisterMemberProperty(1433912761u, BEHAVIAC_NEW CMemberProperty< float >("s2", Set_FirstStruct_s2, Get_FirstStruct_s2));
			...
			// FirstAgent
			meta = BEHAVIAC_NEW AgentMeta(3003525912u);
			AgentMeta::GetAgentMetas()[1778122110u] = meta;
			meta->RegisterMemberProperty(2082220067u, BEHAVIAC_NEW CMemberProperty< FirstStruct >("p1", Set_FirstAgent_p1, Get_FirstAgent_p1));
			meta->RegisterMethod(2394084320u, BEHAVIAC_NEW CAgentMethod< int >(FunctionPointer_FirstAgent_GetP1s1));
