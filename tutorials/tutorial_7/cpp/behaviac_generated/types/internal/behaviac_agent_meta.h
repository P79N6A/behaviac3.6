...
namespace behaviac
{
	...
	inline void FunctionPointer_FirstAgent_Start(Agent* self) { ((FirstAgent*)self)->_Execute_Method_<METHOD_TYPE_FirstAgent_Start, void >(); }
	inline behaviac::EBTStatus FunctionPointer_FirstAgent_Wait(Agent* self) { return (behaviac::EBTStatus)((FirstAgent*)self)->_Execute_Method_<METHOD_TYPE_FirstAgent_Wait, behaviac::EBTStatus >(); }
}
