...
#endif
			// locals
			pBT->AddLocal("framework::GameObject", "int", "par_homing_a", "0");
			// children
			{
...
#endif
			// locals
			pBT->AddLocal("framework::Projectile", "bool", "par_test_a", "false");
			pBT->AddLocal("framework::Projectile", "int", "par_test_b", "0");
			pBT->AddLocal("framework::Projectile", "float", "par_test_c", "0");
			pBT->AddLocal("framework::Projectile", "uint", "par_test_d", "0");
			// children
			{
...
#endif
			// locals
			pBT->AddLocal("framework::Ship", "float", "par_c", "1000");
			// children
			{
...
#endif
			// locals
			pBT->AddLocal("framework::Ship", "int", "par_b", "0");
			// children
			{
				Selector* node1 = BEHAVIAC_NEW Selector;
				node1->SetClassNameString("Selector");
