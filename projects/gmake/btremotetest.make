...
ifeq ($(config),debugstatic32)
  OBJDIR     = ../../intermediate/debugstatic/gmake/btremotetest/x32
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/btremotetest_debugstatic_win32_gmake.exe
...
ifeq ($(config),releasestatic32)
  OBJDIR     = ../../intermediate/releasestatic/gmake/btremotetest/x32
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/btremotetest_releasestatic_win32_gmake.exe
...
$(OBJDIR)/behaviac_agent_meta.o: ../../test/btremotetest/workspace/exported/behaviac_generated/types/internal/behaviac_agent_meta.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
