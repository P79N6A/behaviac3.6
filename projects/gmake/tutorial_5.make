...
ifeq ($(config),debugstatic32)
  OBJDIR     = ../../intermediate/debugstatic/gmake/tutorial_5/x32
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/tutorial_5_debugstatic_win32_gmake.exe
...
ifeq ($(config),releasestatic32)
  OBJDIR     = ../../intermediate/releasestatic/gmake/tutorial_5/x32
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/tutorial_5_releasestatic_win32_gmake.exe
...
$(OBJDIR)/tutorial_5.o: ../../tutorials/tutorial_5/cpp/tutorial_5.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"

$(OBJDIR)/behaviac_agent_meta.o: ../../tutorials/tutorial_5/cpp/behaviac_generated/types/internal/behaviac_agent_meta.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"

$(OBJDIR)/FirstAgent.o: ../../tutorials/tutorial_5/cpp/behaviac_generated/types/internal/FirstAgent.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
