...
ifeq ($(config),debugstatic32)
  OBJDIR     = ../../intermediate/debugstatic/gmake/tutorial_1_2/x32
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/tutorial_1_2_debugstatic_win32_gmake.exe
...
ifeq ($(config),releasestatic32)
  OBJDIR     = ../../intermediate/releasestatic/gmake/tutorial_1_2/x32
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/tutorial_1_2_releasestatic_win32_gmake.exe
...
$(OBJDIR)/SecondAgent.o: ../../tutorials/tutorial_1_2/cpp/SecondAgent.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"

$(OBJDIR)/tutorial_1_2.o: ../../tutorials/tutorial_1_2/cpp/tutorial_1_2.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"

$(OBJDIR)/behaviac_agent_meta.o: ../../tutorials/tutorial_1_2/cpp/behaviac_generated/types/internal/behaviac_agent_meta.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
