...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			...
			AgentMeta::SetTotalSignature(2970163408u);
			...
			// CBTPlayer
			meta = BEHAVIAC_NEW AgentMeta(2259110346u);
			AgentMeta::GetAgentMetas()[2361377009u] = meta;
			meta->RegisterMemberProperty(1881561774u, BEHAVIAC_NEW CMemberProperty< int >("m_Frames", Set_CBTPlayer_m_Frames, Get_CBTPlayer_m_Frames));
